defmodule KickTracker.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      # PLTs cached by CI between runs (§19.1).
      dialyzer: [
  ...
  defp aliases do
    [
      ...
      "assets.build": ["compile", "tailwind kick_tracker", "esbuild kick_tracker"],
      "assets.deploy": [
        "tailwind kick_tracker --minify",
        "esbuild kick_tracker --minify",
        "phx.digest"
      ],
