...
config :kick_tracker, KickTrackerWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: KickTrackerWeb.ErrorHTML, json: KickTrackerWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: KickTracker.PubSub,
  live_view: [signing_salt: "aZRpRx1S"]
...
config :kick_tracker, KickTracker.Mailer, adapter: Swoosh.Adapters.Local
