...
config :kick_tracker, KickTrackerWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "A0gAHEKeh2LFFEGQmT4Xw48fI3zlFr0R0+Y+vsuAVCbUUgM4ugKj8If3MTJZ3HA3",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:kick_tracker, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:kick_tracker, ~w(--watch)]}
  ]
...
config :kick_tracker, dev_routes: true
